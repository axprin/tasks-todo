...
const store = new Vuex.Store({
  state: {
    tasks: [
      ...
      // { id: 4, name: 'Overdue task 1', details: 'This was already due', completed: false, dueDate: moment(new Date()).add(-10, 'days').toDate() },
      // { id: 5, name: 'Overdue task 2', details: 'This was already due', completed: false, dueDate: moment(new Date()).add(-4, 'days').toDate() },
    ],
  },
  mutations: {
    addTask: (state, task) => {
